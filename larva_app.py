...
# Load my catboost model for larvae
model = CatBoostRegressor()
model.load_model("catboost_model.cbm")

st.title("🐛 Larva Death Time Predictor (Mealworms only)")
...
st.subheader("Please enter your larva's features (missing values are accepted!):")
